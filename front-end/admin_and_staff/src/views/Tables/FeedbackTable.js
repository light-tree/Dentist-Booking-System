...
function FeedbackTable() {
  ...
  const getAllService = async () => {
    try {
      const result = await serviceApi.getServiceListForStaff();
      if (result) {
  ...
  const searchFeedback = async () => {
    ...
    try {
      const result = await FeedbackApi.getFeedback(data);
      if (result) {
  ...
  const approveFeedback = async () => {
    try {
      const result = await FeedbackApi.approveFeedback(feedbackDetail.id);
      if (result) {
  ...
  const disapproveFeedback = async () => {
    try {
      const result = await FeedbackApi.disapproveFeedback(feedbackDetail.id);
      if (result) {
